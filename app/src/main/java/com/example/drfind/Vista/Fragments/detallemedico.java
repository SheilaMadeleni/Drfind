...
import com.example.drfind.Controlador.adaptadores.Adaptadordetallemedico;
...
public class detallemedico extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Integer idespeci = getActivity().getIntent().getIntExtra("idespeci",1);
        // getActivity().getIntent().getStringExtra("idespeci");
